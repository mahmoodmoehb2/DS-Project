""" Streamlit page for RQ2 about heatwaves and city size.

The page loads the heatwave data and shows the RQ2 results.
It compares different city-size groups in Germany.
"""
...
def _render_rq2_content():
    # Build the content of the RQ2 page.
