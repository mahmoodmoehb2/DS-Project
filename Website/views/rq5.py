...
def _render_rq5_content():
    ...
    st.title("How has the UV Index in Europe changed over the past 25 years?")

    st.markdown(
        """
        *Research question:* How has the UV Index across Europe changed over the past 25
    ...
    df = pd.read_csv("/Users/timostalschus/Desktop/DS-Project/Website/data/RQ5_uvIndex.csv")
    ...
    with information_about_uv_box:
        st.subheader("Information on the UV-Index in 2000")
    ...
    df_trends = pd.read_csv("/Users/timostalschus/Desktop/DS-Project/Website/data/RQ5_trends.csv")
